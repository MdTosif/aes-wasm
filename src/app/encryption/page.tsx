...
import { BiDownArrowCircle, BiSolidDownArrowSquare } from "react-icons/bi";
import { BsArrowDown, BsArrowDownSquare, BsKeyFill } from "react-icons/bs";
  ...
  const handleFileInputChange = (file: FileList | null) => {
    ...
    if (file && file[0]) {
      ...
      reader.onload = () => {
        ...
        let enc = wasm.encrypt(encKeys.key, encKeys.nonce, bytes);
  ...
  return (
    <div className="card mx-auto">
      <div className="card-body">
        <h2 className="card-title">Encrypt the file</h2>
